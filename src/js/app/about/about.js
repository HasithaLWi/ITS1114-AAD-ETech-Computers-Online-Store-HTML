    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl space-y-10 pb-12">
      ...
      <div class="relative overflow-hidden bg-white border border-[#e2e8f0] rounded-2xl p-6 sm:p-10 shadow-sm">
        ...
        <div class="relative z-10 space-y-4 max-w-3xl">
          <div class="flex flex-wrap items-center gap-2">
            ...
            <span class="px-3 py-1 rounded-full text-[10px] font-mono font-bold uppercase tracking-widest bg-emerald-50 text-emerald-700 border border-emerald-200">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-white border border-[#e2e8f0] rounded-xl p-5 text-center shadow-sm relative group hover:border-[#cbd5e1] transition-colors">
          <span class="text-3xl font-extrabold font-mono text-[#0f172a] block mb-1">${business.stats?.customersServed || '15,000+'}</span>
          <span class="text-xs text-blue-600 font-semibold uppercase tracking-wider block">Satisfied Gamers & Studios</span>
          <span class="text-[10px] text-[#64748b] mt-1 block">Nationwide across Sri Lanka</span>
        </div>
        ...
        <div class="bg-white border border-[#e2e8f0] rounded-xl p-5 text-center shadow-sm relative group hover:border-[#cbd5e1] transition-colors">
          ...
          <span class="text-[10px] text-[#64748b] mt-1 block">Colombo • Galle • Matara • Kandy</span>
        </div>

        <div class="bg-white border border-[#e2e8f0] rounded-xl p-5 text-center shadow-sm relative group hover:border-[#cbd5e1] transition-colors">
          <span class="text-3xl font-extrabold font-mono text-emerald-600 block mb-1">${business.stats?.onTimeDelivery || '99.8%'}</span>
          <span class="text-xs text-[#0f172a] font-semibold uppercase tracking-wider block">Fulfillment SLA</span>
          <span class="text-[10px] text-[#64748b] mt-1 block">Secure Fragile-Care Transport</span>
        </div>

        <div class="bg-white border border-[#e2e8f0] rounded-xl p-5 text-center shadow-sm relative group hover:border-[#cbd5e1] transition-colors">
          <span class="text-3xl font-extrabold font-mono text-amber-600 block mb-1">100%</span>
          <span class="text-xs text-[#0f172a] font-semibold uppercase tracking-wider block">Authentic Hardware</span>
          <span class="text-[10px] text-[#64748b] mt-1 block">Direct Factory Warranties</span>
        </div>
      </div>
          ...
          <table class="w-full text-left text-xs border-collapse">
            <tbody class="divide-y divide-[#e2e8f0]">
              <tr class="hover:bg-[#f8fafc] transition-colors">
                ...
                <td class="py-3 px-5 text-[#0f172a] font-semibold">${business.storeName} (${business.tagline})</td>
              </tr>
              <tr class="hover:bg-[#f8fafc] transition-colors">
                <td class="py-3 px-5 font-bold text-[#475569] bg-[#f8fafc] uppercase text-[10px] tracking-wider">Business Registration Number</td>
                <td class="py-3 px-5 font-mono text-blue-600 font-bold">${business.registrationNo}</td>
              </tr>
              <tr class="hover:bg-[#f8fafc] transition-colors">
                ...
                <td class="py-3 px-5 font-mono text-blue-600 font-bold">${business.taxId}</td>
              </tr>
              <tr class="hover:bg-[#f8fafc] transition-colors">
              ...
              <tr class="hover:bg-[#f8fafc] transition-colors">
                ...
                <td class="py-3 px-5 text-[#0f172a]">${business.headquarters}</td>
              </tr>
              <tr class="hover:bg-[#f8fafc] transition-colors">
                ...
                <td class="py-3 px-5 text-[#0f172a] font-mono font-bold">${business.hotline}</td>
              </tr>
              <tr class="hover:bg-[#f8fafc] transition-colors">
                ...
                <td class="py-3 px-5 text-blue-600 font-mono"><a href="mailto:${business.supportEmail}" class="hover:underline">${business.supportEmail}</a></td>
              </tr>
              <tr class="hover:bg-[#f8fafc] transition-colors">
                <td class="py-3 px-5 font-bold text-[#475569] bg-[#f8fafc] uppercase text-[10px] tracking-wider">Store Operating & Dispatch Hours</td>
                <td class="py-3 px-5 text-[#475569]">${business.workingHours}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white border border-[#e2e8f0] rounded-xl p-6 space-y-3 shadow-sm">
          <div class="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center border border-blue-200">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
          </div>
          <h3 class="text-sm font-bold text-[#0f172a]">Direct OEM Importer</h3>
        ...
        <div class="bg-white border border-[#e2e8f0] rounded-xl p-6 space-y-3 shadow-sm">
          ...
          <h3 class="text-sm font-bold text-[#0f172a]">24-Hour Stress Testing</h3>
          <p class="text-xs text-[#475569] leading-relaxed">
        ...
        <div class="bg-white border border-[#e2e8f0] rounded-xl p-6 space-y-3 shadow-sm">
          ...
          <h3 class="text-sm font-bold text-[#0f172a]">Regional Warehouse Network</h3>
          <p class="text-xs text-[#475569] leading-relaxed">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-lg font-bold text-[#0f172a]">Regional Warehouses & Collection Points</h2>
            <p class="text-xs text-[#64748b]">Visit our regional tech hubs for hardware consultations and order collections.</p>
          </div>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ${branches.map(b => `
            <div class="bg-white border border-[#e2e8f0] rounded-xl p-4 space-y-2.5 shadow-sm relative">
              <div class="flex items-center justify-between">
              ...
              <h4 class="text-sm font-bold text-[#0f172a]">${b.name}</h4>
              <p class="text-xs text-[#64748b] line-clamp-2">${b.address}</p>
      ...
      <div class="bg-white border border-[#e2e8f0] rounded-xl p-6 sm:p-8 space-y-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e2e8f0] pb-4">
          <div>
            ...
            <p class="text-xs text-[#64748b] mt-1">Our binding commitments regarding data privacy, store terms of service, and 2-year warranty protections.</p>
          </div>
          <div class="flex flex-wrap items-center gap-2">
            <a href="#privacy" class="px-3.5 py-1.5 rounded-lg text-xs font-bold bg-[#f8fafc] text-blue-600 hover:text-blue-700 hover:bg-[#f1f5f9] border border-[#e2e8f0] transition-all shadow-sm">
              Privacy Policy
            </a>
            <a href="#terms" class="px-3.5 py-1.5 rounded-lg text-xs font-bold bg-[#f8fafc] text-blue-600 hover:text-blue-700 hover:bg-[#f1f5f9] border border-[#e2e8f0] transition-all shadow-sm">
              Terms of Service
            </a>
            <a href="#warranty" class="px-3.5 py-1.5 rounded-lg text-xs font-bold bg-[#f8fafc] text-emerald-600 hover:text-emerald-700 hover:bg-[#f1f5f9] border border-[#e2e8f0] transition-all shadow-sm">
              Guarantee & Warranty
            </a>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          <!-- Privacy Policy Card -->
          <div class="bg-[#f8fafc] border border-[#e2e8f0] rounded-lg p-5 space-y-3 flex flex-col justify-between hover:border-[#cbd5e1] transition-colors shadow-sm">
            <div class="space-y-2">
              <div class="flex items-center space-x-2 text-blue-600">
                ${policies.privacy?.icon || ''}
                <h4 class="text-sm font-bold text-[#0f172a]">${policies.privacy?.title || 'Privacy Policy'}</h4>
              </div>
              <p class="text-xs text-[#64748b] leading-relaxed">
                ${policies.privacy?.subtitle || 'How we protect and handle your personal data.'}
              </p>
              <div class="text-[11px] text-[#475569] space-y-1 pt-1">
                <p>• 256-bit SSL encrypted transactions</p>
                <p>• Zero third-party data broker sharing</p>
                <p>• Full customer data deletion rights</p>
              </div>
            </div>
            <a href="#privacy" class="inline-flex items-center space-x-1.5 text-xs font-bold text-blue-600 hover:text-blue-700 pt-2">
          ...
          <div class="bg-[#f8fafc] border border-[#e2e8f0] rounded-lg p-5 space-y-3 flex flex-col justify-between hover:border-[#cbd5e1] transition-colors shadow-sm">
            <div class="space-y-2">
              <div class="flex items-center space-x-2 text-blue-600">
                ${policies.terms?.icon || ''}
                <h4 class="text-sm font-bold text-[#0f172a]">${policies.terms?.title || 'Terms of Service'}</h4>
              </div>
              <p class="text-xs text-[#64748b] leading-relaxed">
            ...
            <a href="#terms" class="inline-flex items-center space-x-1.5 text-xs font-bold text-blue-600 hover:text-blue-700 pt-2">
          ...
          <div class="bg-[#f8fafc] border border-[#e2e8f0] rounded-lg p-5 space-y-3 flex flex-col justify-between hover:border-[#cbd5e1] transition-colors shadow-sm">
            <div class="space-y-2">
              <div class="flex items-center space-x-2 text-emerald-600">
                ...
                <h4 class="text-sm font-bold text-[#0f172a]">${policies.warranty?.title || 'Guarantee & Warranty'}</h4>
              </div>
              <p class="text-xs text-[#64748b] leading-relaxed">
            ...
            <a href="#warranty" class="inline-flex items-center space-x-1.5 text-xs font-bold text-emerald-600 hover:text-emerald-700 pt-2">
